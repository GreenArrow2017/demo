...
# myModel = timm.create_model('vit_small_patch16_224', pretrained=True, num_classes=10)
# myModel = timm.create_model('vit_small_r26_s32_224', pretrained=True, num_classes=10)
myModel = timm.create_model('vit_small_patch16_224_in21k', pretrained=True, num_classes = 10)
num_in_features = myModel.get_classifier().in_features
